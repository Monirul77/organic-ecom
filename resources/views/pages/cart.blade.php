                                ...
                                <tr>
                                    ...
                                    <td class="shoping__cart__item__close">
                                          ...
                                          <!--   <a href="{{ url('cart/destroy/'.$cart->id) }}"> <span class="icon_close">
                                            ...
                                            <a href="{{ url('cart/destroy/'.$cart->id) }}"  class="btn btn-sm btn-danger" onclick="return confirm('Are You Sure To Delete')"><i class="fa fa-trash"></i></a>
                                          <!--   <a href="{{ url('cart/destroy/'.$cart->id) }}"> <i class="fa fa-trash"></i>
                                            </a> -->
                ...
                <div class="col-lg-6">
                    <div class="shoping__checkout">
                        ...
                        @if (Session::has('coupon'))
                            ...
                            <li>Discount <span>{{ session()->get('coupon')['coupon_discount'] }}%</span></li>
